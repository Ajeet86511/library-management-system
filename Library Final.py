...
def admin():
    ...
    win.geometry("400x400+480+180")
    win.resizable(False,False)
    b1=Button(win, height=2,width=25,text=' Add User ',command=adduser,bd=3,bg="maroon",fg="yellow")
    b2=Button(win, height=2,width=25,text=' View User ',command=viewuser,bd=3,bg="maroon",fg="yellow")
    b3=Button(win, height=2,width=25,text=' Delete User ',command=deleteuser,bd=3,bg="maroon",fg="yellow")
    b4=Button(win, height=2,width=25,text=' LogOut ',command=logout,bd=3,bg="maroon",fg="yellow")
    b1.place(x=110,y=70)
...
def home():
    try:
        ...
        b1=Button(window,text=' LOGIN AS LIBRARIAN' ,height=2,width=20,command=loginlibr,bd=3,bg="maroon",fg="yellow")
        b2=Button(window,text=' LOGIN AS ADMIN ', height=2,width=20,command=loginadmin,bd=3,bg="maroon",fg="yellow")
